...
protected:
    ...
    virtual void realSend(cMessage* msg);
...
public:
    ...
    simtime_t getChannelState() override;
    /**
    ...
    void getValidChannelInfo(simtime_t_cref from, simtime_t_cref to, AirFrameVector& out) override;
