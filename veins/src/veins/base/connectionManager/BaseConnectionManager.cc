...
void BaseConnectionManager::initialize(int stage)
{
    ...
    if (stage == 0) {
        ...
        EV_INFO << "llfeng maxInterferenceDistance:" << maxInterferenceDistance << "\n";
...
//        EV_INFO << "from nicid:" << pFromNic->nicId << " ("<< pFromNic->pos.x << "," << pFromNic->pos.y << "," << pFromNic->pos.z << ")" << endl;
//        EV_INFO << "to nicid:" << pToNic->nicId << " ("<< pToNic->pos.x << "," << pToNic->pos.y << "," << pToNic->pos.z << ")" << endl;
        dDistance = pFromNic->pos.sqrdist(pToNic->pos);
//        EV_INFO << "dDistance:" << dDistance << ", maxDistSquared:" << maxDistSquared << endl;
    }

//    EV_INFO << "to rad:" << pToNic->heading.getRad() << ", from rad:" << pFromNic->heading.getRad() << endl;
//    pToNic->heading.getRad();
    if(pToNic->pos.x < pFromNic->pos.x)
...
//            EV_INFO << "nic #" << id << " and #" << nic_i->nicId << " are in range" << endl;
//            EV_INFO << "===================================================================="<< endl;
...
//            EV_INFO << "nic #" << id << " and #" << nic_i->nicId << " are NOT in range" << endl;
//            EV_INFO << "#####################################################################" << endl;
