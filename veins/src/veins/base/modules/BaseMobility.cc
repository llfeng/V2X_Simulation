    ...
    if (stage == 0) {
        ...
        if (world->getParentModule() != nullptr) {
            ...
            if (dispWorldOwner.containsTag("bgb")) {
                ...
                EV_DETAIL << "bgb origin: " << origPGWidth << ", " << origPGHeight << endl;
...
void BaseMobility::updatePosition()
{
    ...
    EV_DETAIL << "cur module: " << getFullName() << " updatePosition: " << move.info() << endl;

    EV_DETAIL << "playgroundScaleX: " << playgroundScaleX << " playgroundScaleY: " << playgroundScaleY << endl;
