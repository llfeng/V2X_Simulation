...
public:
    ...
    virtual double getGain(Coord senderPos, Coord senderOrient, Coord receiverPos, Coord receiverOrient);
    virtual double getSenderGain(Coord ownPos, Coord ownOrient, Coord otherPos);
    virtual double getReceiverGain(Coord ownPos, Coord ownOrient, Coord otherPos);
